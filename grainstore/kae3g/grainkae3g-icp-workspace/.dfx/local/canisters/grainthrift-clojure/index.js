...
import { idlFactory } from './grainthrift-clojure.did.js';
export { idlFactory } from './grainthrift-clojure.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRAINTHRIFT_CLOJURE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grainthrift-clojure.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grainthrift-clojure canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grainthrift-clojure.did.js")._SERVICE>}
 */
export const grainthrift_clojure = createActor(canisterId);
