...
import { idlFactory } from './grain6_icp.did.js';
export { idlFactory } from './grain6_icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRAIN6_ICP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grain6_icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grain6_icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grain6_icp.did.js")._SERVICE>}
 */
export const grain6_icp = createActor(canisterId);
