...
import { idlFactory } from './grainthrift-with-pricing.did.js';
export { idlFactory } from './grainthrift-with-pricing.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRAINTHRIFT_WITH_PRICING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grainthrift-with-pricing.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grainthrift-with-pricing canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grainthrift-with-pricing.did.js")._SERVICE>}
 */
export const grainthrift_with_pricing = createActor(canisterId);
