...
import { idlFactory } from './grain6-website-clojure.did.js';
export { idlFactory } from './grain6-website-clojure.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRAIN6_WEBSITE_CLOJURE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grain6-website-clojure.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grain6-website-clojure canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grain6-website-clojure.did.js")._SERVICE>}
 */
export const grain6_website_clojure = createActor(canisterId);
