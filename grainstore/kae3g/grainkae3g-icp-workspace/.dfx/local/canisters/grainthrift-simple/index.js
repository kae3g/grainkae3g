...
import { idlFactory } from './grainthrift-simple.did.js';
export { idlFactory } from './grainthrift-simple.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GRAINTHRIFT_SIMPLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grainthrift-simple.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grainthrift-simple canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grainthrift-simple.did.js")._SERVICE>}
 */
export const grainthrift_simple = createActor(canisterId);
