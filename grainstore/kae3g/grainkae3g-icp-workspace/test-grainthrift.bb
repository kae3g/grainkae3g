#!/usr/bin/env bb
(println "🌾 GrainThrift Clotoko: Testing compilation...")
...
(defn test-compile
  ...
  ;; Write simple Motoko code for GrainThrift
...
(test-compile "src/grainthrift_clojure/core.clj" "grainthrift-clojure")
