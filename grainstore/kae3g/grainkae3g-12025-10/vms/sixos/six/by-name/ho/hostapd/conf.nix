...
, advertise-regulatory-domain-country-code
, radar-detection
, mode
, enable-ht
, enable-vht
...
# (dot11CountryString)
'' + lib.optionalString (regulatory-domain-country-code != null) ''
country_code=${regulatory-domain-country-code}
'' + ''
...
# from openwrt patch: "Do not scan for overlapping BSSs in HT40+/- mode. :!: Turning this on will violate regulatory requirements!"
noscan=1
...
# (default: 0 = disabled)
ieee80211d=${if advertise-regulatory-domain-country-code then "1" else "0"}

# Enable IEEE 802.11h. This enables radar detection and DFS support if
# available. DFS support is required on outdoor 5 GHz channels in most countries
# of the world. This can be used only with ieee80211d=1.
# (default: 0 = disabled)
ieee80211h=${if radar-detection then "1" else "0"}
...
ieee80211n=${if enable-ht then "1" else "0"}
...
ieee80211ac=${if enable-vht then "1" else "0"}
